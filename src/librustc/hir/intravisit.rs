...
pub enum FnKind<'a> {
    ...
    ItemFn(Name, &'a Generics<'a>, FnHeader, &'a Visibility<'a>, &'a [Attribute]),

    /// fn foo(&self)
    Method(Ident, &'a MethodSig<'a>, Option<&'a Visibility<'a>>, &'a [Attribute]),
...
pub trait Visitor<'v> : Sized {
    ...
    fn visit_mod(&mut self, m: &'v Mod<'v>, _s: Span, n: NodeId) {
        walk_mod(self, m, n)
    }
    ...
    fn visit_decl(&mut self, d: &'v Decl<'v>) {
        walk_decl(self, d)
    }
    ...
    fn visit_fn(&mut self, fk: FnKind<'v>, fd: &'v FnDecl<'v>, b: BodyId, s: Span, id: NodeId) {
        walk_fn(self, fk, fd, b, s, id)
    }
    fn visit_use(&mut self, path: &'v Path<'v>, id: NodeId, hir_id: HirId) {
    ...
    fn visit_variant(&mut self, v: &'v Variant<'v>, g: &'v Generics<'v>, item_id: NodeId) {
...
pub fn walk_mod<'v, V: Visitor<'v>>(visitor: &mut V, module: &'v Mod<'v>, mod_node_id: NodeId) {
...
pub fn walk_decl<'v, V: Visitor<'v>>(visitor: &mut V, declaration: &'v Decl<'v>) {
